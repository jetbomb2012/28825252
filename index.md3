...
<img src="assets/images/drop_tank.jpg" alt="Drop Tank" class="module">  
兩枚掛載，一個時間點。錯過即失敗。

---

### 2️⃣ Win in 7min  
<img src="assets/images/win_7min.jpg" alt="Win in 7min" class="module">  
七分鐘不是預估，是限制。第八分鐘即為錯誤。

---

### 3️⃣ If Fail, Then Door  
<img src="assets/images/fight_door.jpg" alt="Fight Door" class="module">  
失敗不是結束，是門前壓制的開始。
